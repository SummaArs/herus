...
O SIM também possui adaptação local por protótipos inteiros, com orçamento de amostras, versão e rollback. No host, a inferência e a atualização foram medidas para regressão; esses números não representam o desempenho físico do pulso.
...
| [System One / Jev no HERUS](docs/83-SYSTEM-ONE-JEV-NO-HERUS.md) | Decisões tipadas, probabilidades, avaliação paralela e abstention; não é cópia do modelo fechado Jev. |
