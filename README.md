...
&nbsp;·&nbsp; C11, no dependencies &nbsp;·&nbsp; 29 code + 74 system invariants &nbsp;·&nbsp; pre-hardware
...
| `firmware/core/` | Portable C: both algebras, memory, resonator, HCP rev 0.2, Nucleus intelligence, voice/haptic contracts and the confirmed interaction runtime |
...
| `firmware/test/` | Seven proof suites, including Nucleus, voice/haptic and interaction-runtime invariants, crypto vectors from an independent implementation and an SX1262 mock bus |
...
About 30 seconds. Seven suites — algebra, Nucleus intelligence, controlled voice/haptics, interaction runtime, protocol, radio driver and physical layer — plus the simulated bench, and **29 code invariants and 74 system invariants checked rather than eyeballed**:
