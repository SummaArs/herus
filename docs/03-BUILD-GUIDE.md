...
2. Prove everything. One command, twenty-nine suites, 67 proof invariants:
...
[ ] Phase 4   each collection transition interrupted and recovered against its target backend
