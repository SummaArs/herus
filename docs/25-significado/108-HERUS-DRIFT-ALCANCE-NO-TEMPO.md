...
O alcance de rádio do HERUS é limitado por regulação: 400 ms de dwell por canal fazem de SF9 o teto, e o teto urbano são 650 m capsula a capsula ([00-HERUS-MASTER §6](../10-arquitetura/00-HERUS-MASTER.md)). Não há firmware que mude isso.
