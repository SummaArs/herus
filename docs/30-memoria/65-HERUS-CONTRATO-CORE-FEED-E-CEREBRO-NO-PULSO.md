...
Os resultados e limites estão registrados em `66-HERUS-MIGRACAO-HANDLES-E-KNOWLEDGE-FEED.md`. O feed continua sendo um caminho de proposta de produto, não uma autorização para elevar o Core a cérebro remoto.
