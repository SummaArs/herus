...
| Protocolo | exige revisão, instrumento identificado, baseline verde, `null` distinto de zero e `blocked_by_missing_evidence` | `../60-hardware/36-PROTOCOLO-BANCADA-FISICA.md` | interação é genérica; não especifica a sequência HAP-SEM/DRV2605L |
...
| 6 | teste humano segundo `55-HERUS-PROTOCOLO-VALIDACAO-HAPTICA.md` | ética, segurança e matriz de confusão pendentes |
...
- [`../60-hardware/36-PROTOCOLO-BANCADA-FISICA.md`](../60-hardware/36-PROTOCOLO-BANCADA-FISICA.md)
- [`55-HERUS-PROTOCOLO-VALIDACAO-HAPTICA.md`](55-HERUS-PROTOCOLO-VALIDACAO-HAPTICA.md)
