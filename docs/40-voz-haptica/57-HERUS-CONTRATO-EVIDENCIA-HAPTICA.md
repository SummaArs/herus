...
**Base:** [`research/hardware_bench_evidence_schema.json`](../../research/haptic_bench_evidence_schema.json) e [`../60-hardware/36-PROTOCOLO-BANCADA-FISICA.md`](../60-hardware/36-PROTOCOLO-BANCADA-FISICA.md).
...
| 7 | human study | protocolo `55-HERUS-PROTOCOLO-VALIDACAO-HAPTICA.md` | percepção confundida com resultado de bancada |
