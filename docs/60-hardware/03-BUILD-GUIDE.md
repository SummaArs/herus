...
Revision 0.2 · read [00-HERUS-MASTER.md](../10-arquitetura/00-HERUS-MASTER.md) once before starting,
...
2. **This is already written.** `firmware/net/` and `firmware/port/` contain the
   ...
   anything — read [05-FIRMWARE.md](../10-arquitetura/05-FIRMWARE.md) and go straight to §6, which
   ...
   2. **Framing** — the constant 34-byte frame from
      [02-PROTOCOL.md](../10-arquitetura/02-PROTOCOL.md) §3. Pad the plaintext to 22 bytes
      **before** encryption.
