...
A política `autonomy_policy` agora classifica envelopes em `A0`–`A4`, exige consentimento para iniciativa contextual, reduz autonomia diante de incerteza, impede escalada de escopo e permite somente uma confirmação purpose-bound por proposta. A suíte passa **17/17**. A matriz de falhas combinadas passa **24/24**, incluindo Core ausente com conflito local, reboot com slot adulterado, revogação de consentimento e exaustão sem sobrescrita. Com a campanha de Core, a regressão global confirmou **66 suítes**, **111 invariantes de sistema simulado**, mutação histórica **7/7**, red-team de autonomia **7/7**, red-team de magia/memória **5/5**, red-team de Core **7/7** e matriz de falhas combinadas **24/24**.
