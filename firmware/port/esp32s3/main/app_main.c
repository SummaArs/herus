...
static int cmd_send(int argc, char **argv)
{
    (void)argc;
    (void)argv;
    say("send is disabled: the meaning-to-assurance pipeline is not wired on this target");
    say("no raw intent, link frame or radio queue may bypass Babel, HSCA and Aether");
    return 1;
}
