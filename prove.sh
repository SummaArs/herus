...
banner "41/41 symbolic generative intelligence (reason, plan, dialogue)"
...
check "Symbolic dialogue preserves personal authority and abstention" "SYMBOLIC DIALOGUE: 10 pass, 0 fail" /tmp/herus_symbolic.log
