...
check "Memory reboot boundary imports floor only and scrubs semantic evidence" "MEMORY REBOOT BOUNDARY: 14 pass, 0 fail" /tmp/herus_memory_reboot_boundary.log
check "Memory reboot redteam kills stale-context and partial-recovery mutants" "MEMORY REBOOT REDTEAM: 10/10 critical reboot-boundary mutants killed" /tmp/herus_memory_reboot_redteam.log
